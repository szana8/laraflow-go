    ...
    <laraflow-dialog id="callback-configuration" title=" Callback Configuration" :isLarge="true">
        <template slot="laraflow-dialog-body">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="validators" role="tabpanel" aria-labelledby="validators-tab">
                    <validators-tab v-if="callbackObjects" :validators="callbackObjects.validators" :availableRules="rules" @refreshRule="refreshRule">
                ...
                <div class="tab-pane fade" id="prefunctions" role="tabpanel" aria-labelledby="prefunctions-tab">
                    <functions-tab v-if="callbackObjects" :callbacks="callbackObjects.callbacks" :availableFunctions="preFunctions" @refreshed="refreshPreFunction">
                ...
                <div class="tab-pane fade" id="postfunctions" role="tabpanel" aria-labelledby="postfunctions-tab">
                    <functions-tab v-if="callbackObjects" :callbacks="callbackObjects.callbacks" :availableFunctions="postFunctions" @refreshed="refreshPostFunction">
                        <template slot-scope="{functionObj}">
                            {{ functionObj }}
                            <br/>
                            <small>{{ this.callbackObjects.callbacks[Object.keys(functionObj)[0]].description }}</small>
        ...
        <template slot="laraflow-dialog-footer">
            <button type="button" class="btn btn-secondary" @click.prevent="cancel" data-dismiss="modal">Close</button>
